...
REM
REM Generated by Vivado on Fri Jun 24 19:16:31 -0700 2022
...
echo "xvhdl --incr --relax -prj tb_ALU_vhdl.prj"
call xvhdl  --incr --relax -prj tb_ALU_vhdl.prj -log xvhdl.log
